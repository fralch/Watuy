            ...
            <form onSubmit={onSubmit} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        className={`mt-1 block w-full rounded-md shadow-sm focus:border-[#006ba0] focus:ring focus:ring-[#006ba0] focus:ring-opacity-50 transition-colors duration-200 ${
                            isDarkMode 
                ...
                <div className="flex gap-2 justify-end">
                    ...
                    <button
                        type="submit"
                        className="px-4 py-2 bg-[#006ba0] text-white rounded-md hover:bg-blue-700 transition-colors duration-200"
                    >
                        Guardar Filtro
                    </button>
                </div>
