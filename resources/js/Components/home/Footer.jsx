...
const Footer = () => {
  return (
    <>
    <footer className="relative bg-cover bg-center bg-no-repeat bg-primary-900 text-white p-6" style={{ backgroundImage: 'url("/img/footer.jpg")' }}>
      ...
      <div className="relative grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8 p-6">
        ...
        <div>
          <h4 className="font-bold border-b border-white pb-2 mb-4">Sobre watuy.com</h4>
        ...
        <div className="hidden xl:block">
          ...
          <div className="flex space-x-4">
            <a href="#l" target="_blank" rel="noopener noreferrer" className="bg-gray-800 p-2 rounded hover:bg-gray-700">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer" className="bg-gray-800 p-2 rounded hover:bg-gray-700">
