            ...
            <div className="-mx-1 flex flex-col md:flex-row items-center justify-between">
                <ul className="flex flex-col md:flex-row h-10 w-full flex-wrap items-center">
                    <li className="relative block w-full md:w-auto mb-2 md:mb-0">
                        <a
                            href="#"
                            className="mx-1 flex h-12 md:h-10 cursor-pointer items-center justify-center md:justify-start rounded bg-[#006ba0] px-6 md:px-4 leading-10 text-white no-underline transition-colors duration-100 hover:no-underline text-lg md:text-base"
                            onClick={toggleMenu}
                            id="category-button"
                        >
